...
export class FloristicaServiceService {
  ...
  //crear floristica
  create(floristica:Floristica):Observable<Floristica>{
    return this.http.post<Floristica>(this.url,floristica);
  }
  ...
  delete(id_floristica:number):Observable<Floristica>{
